!(function (n) {
  ...
  function a(t, e, n) {
    ...
    return (
      h(t) ||
      ((h((a = t)) || "string" == typeof a) && l(t.replace(X, ""), e, n))
    );
  }
  function m(t, e, n, a) {
    var r = [],
  ...
  function U(t, e) {
    if (Array.isArray(e)) for (var n = 0; n < e.length; n++) U(t, e[n]);
    else t.push(e);
    return t;
  }
  var p,
    ...
    C = function (t, v) {
      ...
      ((v = t),
        ...
        (this.fnPageChange = function (t, e) {
          ((t = this.api(!0).page(t)), (e !== N && !e) || t.draw(!1));
        }),
          ...
          if ("table" != this.nodeName.toLowerCase())
            ...
            var f,
              ...
              m =
                ...
                []);
            if (
              (0 !== (t = this.getElementsByTagName("thead")).length &&
  ...
  function nt(t, e) {
    ...
    (t.aoColumns.push(n),
      ((n = t.aoPreSearchCols)[a] = P.extend({}, C.models.oSearch, n[a])),
      at(t, a, P(e).data()));
  }
  function at(t, e, n) {
    function a(t) {
  ...
  function rt(t, e) {
    return "number" == typeof (t = it(t, "bVisible"))[e] ? t[e] : null;
  }
  function ot(t, e) {
    return ((t = it(t, "bVisible")), -1 !== (e = P.inArray(e, t)) ? e : null);
  }
  function T(t) {
    var n = 0;
    return (
  ...
  function mt(t, e, n, a) {
    ...
    return (
      (e = (e = e.firstChild ? e : e.nTr) && e.getAttribute("id")) &&
        b(t.rowId)(a, e),
      { data: a, cells: u }
    );
  }
  function St(t, e, n, a) {
    ...
    if (null === c.nTr) {
      for (
        ...
        ((i = t.aoColumns[l]),
          (o = (u = !n) ? S.createElement(i.sCellType) : a[l]) ||
          ...
          (!u &&
            ...
            (o.innerHTML = v(t, e, l, "display")),
          i.sClass && (o.className += " " + i.sClass),
          i.bVisible && !n
            ? r.appendChild(o)
            : !i.bVisible && n && o.parentNode.removeChild(o),
          i.fnCreatedCell &&
            i.fnCreatedCell.call(t.oInstance, o, v(t, e, l), f, e, l));
  ...
  function vt(t, e) {
    ...
    n &&
      ...
      a.DT_RowClass &&
        ...
        (e.__rowc = e.__rowc ? Y(e.__rowc.concat(t)) : t),
  ...
  function u(t, e) {
    var n = (a = t.oFeatures).bSort,
      a = a.bFilter;
    (n && ie(t),
      a ? Rt(t, t.oPreviousSearch) : (t.aiDisplay = t.aiDisplayMaster.slice()),
  ...
  function Ct(n, t) {
    var e,
      ...
      f,
      d = P(t).children("tr");
    for (n.splice(0, n.length), r = 0, l = d.length; r < l; r++) n.push([]);
    for (r = 0, l = d.length; r < l; r++)
      for (a = (e = d[r]).firstChild; a; ) {
        if (
          ...
          for (
            ...
            for (o = 0; o < c; o++)
              ((n[r + o][s + i] = { cell: a, unique: f }), (n[r + o].nTr = e));
        a = a.nextSibling;
      }
  }
  function wt(t, e, n) {
  ...
  function At(t) {
    ...
    return (
      ...
      null === (f = C.ext.legacy.ajax) ? (t.sAjaxSource ? u : p) : f ? u : p
    );
  }
  function It(t, n) {
    function e(t, e) {
    ...
    for (
      ...
      if (!(o = t.aoData[s])._aFilterData) {
        for (a = [], e = 0, n = i.length; e < n; e++)
          (i[e].bSearchable
            ? "string" !=
                typeof (r = null === (r = v(t, s, e, "filter")) ? "" : r) &&
              r.toString &&
              (r = r.toString())
            : (r = ""),
            r.indexOf &&
  ...
  function Qt(n) {
    ...
    n.scrollBarVis !== R && n.scrollBarVis !== N
      ...
      : ((n.scrollBarVis = R),
        ...
        R.find("[id]").removeAttr("id"),
        l || ((m.width = "100%"), (f[0].style.width = "100%")),
        ...
        "" === l
          ? ((C.width = "100%"),
            x &&
              ...
              (C.width = k(D.outerWidth() - c)),
            (f = D.outerWidth()))
          : "" !== s && ((C.width = k(s)), (f = D.outerWidth())),
        M(t, e),
        M(function (t) {
        ...
        u || (x && (m.height = k(_.offsetHeight + c))),
        (R = D.outerWidth()),
        (p[0].style.width = k(R)),
        (h.width = k(R)),
        (y = D.height() > g.clientHeight || "scroll" == b.css("overflow-y")),
        (h[(i = "padding" + (T.bScrollbarLeft ? "Left" : "Right"))] = y
          ? c + "px"
          : "0px"),
        w &&
          ((v[0].style.width = k(R)),
          (S[0].style.width = k(R)),
          (S[0].style[i] = y ? c + "px" : "0px")),
  ...
  function ee(t) {
    var e,
      ...
      g = p.bScrollOversize;
    for (
      (m = a.style.width) && -1 !== m.indexOf("%") && (f = m), D = 0;
      D < u.length;
      D++
    )
      null !== (e = r[u[D]]).sWidth &&
        ((e.sWidth = ae(e.sWidthOrig, d)), (h = !0));
    if (g || (!h && !i && !o && s == T(t) && s == c.length))
      for (D = 0; D < s; D++) {
        var b = rt(t, D);
        null !== b && (r[b].sWidth = k(c.eq(D).width()));
      }
    else {
      (m = P(a).clone().css("visibility", "hidden").removeAttr("id"))
        .find("tbody tr")
        .remove();
      var m,
        S = P("<tr/>").appendTo(m.find("tbody"));
      for (
        m.find("thead, tfoot").remove(),
          m.append(P(t.nTHead).clone()).append(P(t.nTFoot).clone()),
          m.find("tfoot th, tfoot td").css("width", ""),
          c = wt(t, m.find("thead")[0]),
          D = 0;
        D < u.length;
        D++
      )
          ...
          y =
            (i && l
              ...
              : i
                ? (m.css("width", "auto"),
                  m.removeAttr("width"),
                  m.width() < d.clientWidth && f && m.width(d.clientWidth))
                : o
                  ? m.width(d.clientWidth)
                  : f && m.width(f),
            0),
          D = 0;
        D < u.length;
  ...
  function re(t, e) {
    ...
    return a < 0
      ...
      : (n = t.aoData[a]).nTr
        ? n.anCells[e]
        : P("<td/>").html(v(t, a, e, "display"))[0];
  }
  function oe(t, e) {
    for (var n, a = -1, r = -1, o = 0, i = t.aoData.length; o < i; o++)
      (n = (n = (n = v(t, o, e, "display") + "").replace(te, "")).replace(
        /&nbsp;/g,
        " ",
  ...
  function pe(n, t, e) {
    ...
    if (t && t.time) {
      ...
      else if (0 < (l = n.iStateDuration) && t.time < +new Date() - 1e3 * l)
        n._bLoadingState = !1;
  ...
  function W(t, e, n, a) {
    if (
      ...
      ((e = (e = C.ext).sErrMode || e.errMode),
      t && R(t, null, "error", [t, a, n]),
      "alert" == e)
    )
      alert(n);
    else {
  ...
  function we(i, t, e, n) {
    ...
    ((function t(e, n) {
      ...
      if (Array.isArray(e) || e instanceof P)
        for (var r = 0, o = e.length; r < o; r++) t(e[r], n);
      else
        e.nodeName && "tr" === e.nodeName.toLowerCase()
          ? l.push(e)
          : ((a = P("<tr><td></td></tr>").addClass(n)),
            (P("td", a).addClass(n).html(e)[0].colSpan = T(i)),
            l.push(a[0]));
    })(e, n),
  ...
  function Te(t, e) {
    ...
    a.length &&
      ...
      R(a[0], null, "childRow", [e, t.row(t[0])]),
      (s = a[0]),
      (r = new B(s)),
      (e = "draw" + (n = ".dt.DT_details")),
      (u = s.aoData),
      r.off(e + " " + (t = "column-sizing" + n) + " " + (n = "destroy" + n)),
      0 < H(u, "_details").length &&
        (r.on(e, function (t, e) {
          s === e &&
            r
              .rows({ page: "current" })
        ...
        r.on(t, function (t, e, n, a) {
          if (s === e)
            for (var r, o = T(e), i = 0, l = u.length; i < l; i++)
              (r = u[i])._details &&
                r._details.children("td[colspan]").attr("colspan", o);
        }),
        r.on(n, function (t, e) {
          if (s === e)
            for (var n = 0, a = u.length; n < a; n++) u[n]._details && Ae(r, n);
        })),
      Le(a));
  }
  function xe(t, e, n, a, r) {
    for (var o = [], i = 0, l = r.length; i < l; i++) o.push(v(t, r[i], e));
    return o;
  }
  function Ae(t, e) {
    var n = t.context;
  ...
  var Ie = [],
    ...
    Fe =
      ...
      P.extend(B.prototype, {
        ...
        unique: function () {
          return new B(this.context, Y(this));
        },
        unshift: o.unshift,
      }),
        ...
        return (
          this.iterator("row", function (t, e, n) {
            ...
            (gt(t.aiDisplayMaster, e),
              ...
              Se(t),
              (n = t.rowIdFn(c._aData)) !== N && delete t.aIds[n]);
          }),
          this.iterator("table", function (t) {
    ...
    Ne =
            ...
            return (
              ...
              De(
                ...
                function (n) {
                  ...
                  var r = "string" == typeof n ? n.match(je) : "";
                  if (r)
                    switch (r[2]) {
                      case "visIdx":
                      case "visible":
      ...
      t("cells().nodes()", "cell().node()", function () {
        return this.iterator(
          "cell",
          function (t, e, n) {
            return (t = t.aoData[e]) && t.anCells ? t.anCells[n] : N;
          },
          1,
        );
      }),
        ...
        return (
          ...
          this.iterator("table", function (e) {
            ...
            (l[(o = c ? "remove" : "detach")](),
              ...
              -1 !== (u = P.inArray(e, C.settings)) && C.settings.splice(u, 1));
          })
        );
      }),
  ...
  (P.extend(Ne, {
        ...
        _: function (u, t, c, e, f, d) {
          ...
          ((function t(e, n) {
            for (
              ...
              if (((a = n[l]), Array.isArray(a)))
                t(P("<" + (a.DT_el || "div") + "/>").appendTo(e), a);
              else {
                switch (((h = null), (p = a), (r = u.iTabIndex), a)) {
                  case "ellipsis":
                    e.append('<span class="ellipsis">&#x2026;</span>');
                    break;
                  case "first":
                    ((h = b.sFirst), 0 === f && ((r = -1), (p += " " + o)));
                    break;
                  case "previous":
                    ((h = b.sPrevious), 0 === f && ((r = -1), (p += " " + o)));
                    break;
                  case "next":
                    ((h = b.sNext),
                      (0 !== d && f !== d - 1) || ((r = -1), (p += " " + o)));
                  ...
                  case "last":
                    ...
                    break;
                  default:
                    ((h = u.fnFormatNumber(a + 1)),
                      (p = f === a ? g.sPageButtonActive : ""));
                }
                null !== h &&
                  me(
                    P("<a>", {
    ...
    P.extend(C.ext.type.detect, [
      function (t, e) {
        return l(t, (e = e.oLanguage.sDecimal)) ? "num" + e : null;
      },
      function (t, e) {
        var n;
        return (!t || t instanceof Date || J.test(t)) &&
          ((null !== (n = Date.parse(t)) && !isNaN(n)) || h(t))
          ? "date"
          : null;
      },
      function (t, e) {
        return l(t, (e = e.oLanguage.sDecimal), !0) ? "num-fmt" + e : null;
      },
      function (t, e) {
        return a(t, (e = e.oLanguage.sDecimal)) ? "html-num" + e : null;
      },
      function (t, e) {
        return a(t, (e = e.oLanguage.sDecimal), !0) ? "html-num-fmt" + e : null;
      },
      function (t, e) {
    ...
    P.extend(C.ext.type.search, {
      html: function (t) {
        return h(t)
          ? t
          : "string" == typeof t
            ? t.replace(V, " ").replace(X, "")
            : "";
      },
      string: function (t) {
        return h(t) || "string" != typeof t ? t : t.replace(V, " ");
      },
    }),
                  ...
                  ? "sort" === e
                    ...
                    : ((t =
                        null === r
                          ...
                          : We(n, "format", "toFormat", "toISOString", r)),
                      "display" === e ? ke(t) : t)
                  : t
          );
        }
  ...
  if (Intl)
    try {
      for (
        var Je = new Intl.NumberFormat().formatToParts(100000.1), n = 0;
        n < Je.length;
        n++
      )
        "group" === Je[n].type
          ? (Ve = Je[n].value)
          : "decimal" === Je[n].type && (Xe = Je[n].value);
    } catch (t) {}
  function qe(e) {
    return function () {
