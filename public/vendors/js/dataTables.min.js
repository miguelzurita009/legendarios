!(function (n) {
                ...
                for (a = [], e = 0, n = i.length; e < n; e++)
                    (i[e].bSearchable
                        ...
                        r.indexOf &&
                            -1 !== r.indexOf("&") &&
                            ((Mt.innerHTML = r),
                            (r = kt ? Mt.textContent : Mt.innerText)),
    ...
    function pe(n, t, e) {
        ...
        if (t && t.time) {
            ...
            if (-1 !== P.inArray(!1, l)) n._bLoadingState = !1;
                ...
                0 < (l = n.iStateDuration) &&
                t.time < +new Date() - 1e3 * l
            )
                n._bLoadingState = !1;
                ...
                if (
                    ...
                    for (a = 0, r = t.columns.length; a < r; a++) {
                        ...
                        (s.visible !== N &&
                            ...
                            s.search !== N &&
                                P.extend(n.aoPreSearchCols[a], Bt(s.search)));
                    }
                    i && i.columns.adjust();
                }
                ((n._bLoadingState = !1),
    ...
    function Te(t, e) {
        ...
        a.length &&
            ...
            (u = s.aoData),
            r.off(
                e + " " + (t = "column-sizing" + n) + " " + (n = "destroy" + n),
            ),
                ...
                return (
                    ...
                    this.iterator("table", function (e) {
                        ...
                        (l[(o = c ? "remove" : "detach")](),
                            ...
                            -1 !== (u = P.inArray(e, C.settings)) &&
                                C.settings.splice(u, 1));
                    })
                );
            }),
    ...
    (P.extend(Ne, {
        ...
        P.extend(C.ext.type.detect, [
            ...
            function (t, e) {
                return l(t, (e = e.oLanguage.sDecimal), !0)
                    ? "num-fmt" + e
                    : null;
            },
            function (t, e) {
            ...
            function (t, e) {
                return a(t, (e = e.oLanguage.sDecimal), !0)
                    ? "html-num-fmt" + e
                    : null;
            },
            function (t, e) {
            ...
            return (
                C.ext.type.order[l] ||
                    ...
                    (C.ext.type.order[l + "-asc"] = function (t, e) {
                        return (t = t.valueOf()) === (e = e.valueOf())
                            ? 0
                            : t < e
                              ? -1
                              : 1;
