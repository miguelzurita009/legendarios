...
($(window).resize(function () {
    ...
    $(document).ready(function () {
        ($(".nxl-mega-menu-sm").on("click", function (e) {
            (e.preventDefault(),
                $("#mega-menu-dropdown")
                    .addClass("nxl-mega-menu-sm")
                    .removeClass(
                        "nxl-mega-menu-md nxl-mega-menu-lg nxl-mega-menu-xl nxl-mega-menu-xxl nxl-mega-menu-full",
                    ));
        }),
            $(".nxl-mega-menu-md").on("click", function (e) {
                (e.preventDefault(),
                    $("#mega-menu-dropdown")
                        .addClass("nxl-mega-menu-md")
                        .removeClass(
                            "nxl-mega-menu-sm nxl-mega-menu-lg nxl-mega-menu-xl nxl-mega-menu-xxl nxl-mega-menu-full",
                        ));
            }),
            $(".nxl-mega-menu-lg").on("click", function (e) {
                (e.preventDefault(),
                    $("#mega-menu-dropdown")
                        .addClass("nxl-mega-menu-lg")
                        .removeClass(
                            "nxl-mega-menu-sm nxl-mega-menu-md nxl-mega-menu-xl nxl-mega-menu-xxl nxl-mega-menu-full",
                        ));
            }),
            $(".nxl-mega-menu-xl").on("click", function (e) {
                (e.preventDefault(),
                    $("#mega-menu-dropdown")
                        .addClass("nxl-mega-menu-xl")
                        .removeClass(
                            "nxl-mega-menu-sm nxl-mega-menu-md nxl-mega-menu-lg nxl-mega-menu-xxl nxl-mega-menu-full",
                        ));
            }),
            $(".nxl-mega-menu-xxl").on("click", function (e) {
                (e.preventDefault(),
                    $("#mega-menu-dropdown")
                        .addClass("nxl-mega-menu-xxl")
                        .removeClass(
                            "nxl-mega-menu-sm nxl-mega-menu-md nxl-mega-menu-lg nxl-mega-menu-xl nxl-mega-menu-full",
                        ));
            }),
            $(".nxl-mega-menu-full").on("click", function (e) {
                (e.preventDefault(),
                    $("#mega-menu-dropdown")
                        .addClass("nxl-mega-menu-full")
                        .removeClass(
                            "nxl-mega-menu-sm nxl-mega-menu-md nxl-mega-menu-lg nxl-mega-menu-xl nxl-mega-menu-xxl",
                        ));
            }));
    }),
    $(function () {
    ...
    $(document).on("click", ".page-content-left-open-toggle", function (e) {
        (e.preventDefault(),
            $(".page-content-left-sidebar-wrapper")
                .addClass("page-content-left-open")
                .removeClass("page-content-left-close"));
    }),
    $(document).on("click", ".page-content-left-close-toggle", function (e) {
        (e.preventDefault(),
            $(".page-content-left-sidebar-wrapper")
                .addClass("page-content-left-close")
                .removeClass("page-content-left-open"));
    }),
    $(document).on("click", ".page-content-right-open-toggle", function (e) {
        (e.preventDefault(),
            $(".page-content-right-sidebar-wrapper")
                .addClass("page-content-right-open")
                .removeClass("page-content-right-close"));
    }),
    $(document).on("click", ".page-content-right-close-toggle", function (e) {
        (e.preventDefault(),
            $(".page-content-right-sidebar-wrapper")
                .addClass("page-content-right-close")
                .removeClass("page-content-right-open"));
    }),
    $(document).ready(function () {
        $(".file-download").on("click", function (e) {
            (e.preventDefault(), $("#toast").toast("show"));
        });
    }),
    $(document).ready(function () {
        var e = {
            ...
            initComponent: function () {
                ($(document).on(
                    ...
                    function (e) {
                        ...
                        var n,
                            t = $(this).closest(".card");
                        $(t).hasClass("card-loading") ||
                            ((n = $(t).find(".custom-card-action")),
                            (e =
                                '<div class="card-loader"><div class="spinner-border ' +
                                ($(this).attr("data-spinner-class")
                                    ? $(this).attr("data-spinner-class")
                                    : "text-primary") +
                                '"></div></div>'),
                            $(t).addClass("card-loading"),
                            (0 !== $(n).length ? $(n) : $(t)).append(e),
                            setTimeout(function () {
                                ($(t).removeClass("card-loading"),
                                    $(t).find(".card-loader").remove());
                            }, 3e3));
                    },
                ),
                    $(document).on(
                        ...
                        function (e) {
                            ...
                            var n = $(this).closest(".card"),
                                t = $(n).find(".custom-card-action"),
                                a = "card-expand";
                            (0 !== $(t).length &&
                                ((e = $(n).offset().top), $(t).offset().top),
                                $("body").hasClass(a) && $(n).hasClass(a)
                                    ? ($("body, .card").removeClass(a),
                                      $(".card").removeAttr("style"),
                                      $(t).removeAttr("style"))
                                    : ($("body").addClass(a),
                                      $(this).closest(".card").addClass(a)),
    ...
    $(document).ready(function () {
        $(".successAlertMessage").click(function (e) {
            (e.preventDefault(),
                Swal.mixin({
                    toast: !0,
                    position: "top-end",
    ...
    document.addEventListener("DOMContentLoaded", function () {
        992 < window.innerWidth &&
            document
                .querySelectorAll(".nxl-header .header-wrapper .dropdown")
                .forEach(function (e) {
                    (e.addEventListener("mouseover", function (e) {
                        var n,
                            t = this.querySelector("a[data-bs-toggle]");
                        null != t &&
